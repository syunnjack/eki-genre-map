...
const postKey = 'eki-genre-map.posts'
const savedKey = 'eki-genre-map.saved'
const items = [
  {
    "id": "eki-genre-map-1",
    "title": "Nagoya station opportunity",
    "category": "station",
    "area": "Nagoya",
    "summary": "Station and genre based discovery map for cafes, karaoke, clinics, waiting spots and practical local facilities. This page is designed as a searchable seed record with review intent, update status and conversion context.",
    "score": 92,
  ...
  },
  {
    ...
    "revenue": "featured venue slots"
  },
  {
    "id": "eki-genre-map-3",
    "title": "Osaka karaoke opportunity",
    "category": "karaoke",
    "area": "Osaka",
    "summary": "Station and genre based discovery map for cafes, karaoke, clinics, waiting spots and practical local facilities. This page is designed as a searchable seed record with review intent, update status and conversion context.",
    "score": 78,
    ...
    "revenue": "coupon traffic"
  }
]
const revenuePlans = [
  "local ads",
  "featured venue slots",
  "coupon traffic",
  "reservation leads",
  "MEO support"
]
...
function App() {
  ...
  const [form, setForm] = useState({ title: '', category: 'station', body: '' })
  ...
  function submitPost(event) {
    ...
    setForm({ title: '', category: 'station', body: '' })
  }
  ...
  return (
    <main className="app-shell">
      <section className="hero">
        <div>
          <span className="brand">ekigenre.jp / eki-genre-map</span>
          <h1>Eki Genre Map</h1>
          <p>Station and genre based discovery map for cafes, karaoke, clinics, waiting spots and practical local facilities.</p>
        </div>
        <aside className="answer-box">
          <small>AI overview answer</small>
          <strong>Eki Genre Map helps users compare, verify and act faster.</strong>
      ...
      <section className="ugc-section">
        ...
        <form className="ugc-form" onSubmit={submitPost}>
          ...
          <select value={form.category} onChange={(event) => setForm({ ...form, category: event.target.value })}>
            {["station","cafe","karaoke","clinic","game center"].map((item) => <option key={item}>{item}</option>)}
          </select>
